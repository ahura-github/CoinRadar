...
//       currentHoldings: 1.5)
    ...
    let stats: [Statistic] = [
        Statistic(title: "Market Cap", value: "$12.5Bn", percentage: 25.34),
        Statistic(title: "Portfolio Volume", value: "$50.4K", percentage: -5.34),
        Statistic(title: "Total Volume", value:"$1.3Tr"),
        Statistic(title: "24h Volume", value: "336.3Bn")
    ]
}
